...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        hidden_layer_error = hidden_layer_error = np.multiply(
        ...
        # Inside the train method, after computing output_layer_error
        training_loss = 0.5 * (output_layer_error ** 2).item()  # Squared loss
