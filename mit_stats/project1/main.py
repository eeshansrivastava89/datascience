...
# Your code here
# best method = pegasos, params: T = 25, L = 0.01, Accuracy = 0.8060
...
# thetas_pegasos = p1.pegasos(train_bow_features, train_labels, T=25, L=0.01)

# best_theta = np.array(thetas_pegasos[0]) # Your code here
